...
// const quote =("If it is meant to be, it is up to me!")

// for(let i=0; i < quote.length; i++){
//     if(`${quote}`=== 'a' || (`${quote}`=== 'e' ||
//     `${quote}`=== 'i' (`${quote}`=== 'o'(`${quote} === 'u')
// {console.log(`${quote[1]}`);{}
// }++++++cvcv
// }
...
//      If a word has the letter a in it, log it to the console
 ...
 let names = ['eric', 'jordan', 'kelly', 'daniel']
...
let food = ['pizza', 'pasta', 'pudding', 'pie']

let upper1 = []

for(let i=0; i < food.length; i++){
    for(let j=0; j < food[i].length; j +=2){
        food[i][j].push
        upper1.push(food[j])
    }
